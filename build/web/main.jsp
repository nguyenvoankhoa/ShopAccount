...
<html>
    ...
    <body>
        ...
        <div class="row col-12 m-0">
            <div class="video container mt-5 p-0" style="background-color: #fff">
                <iframe class="iframe" src="https://www.youtube.com/embed/h7MYJghRWt0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <iframe class="iframe2" src="https://www.youtube.com/embed/wiBry2wtgB0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
        ...
        <div class="row main-account py-4">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center" style="margin-top: 12px;">
            ...
            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-7 text-center">
                <div class="title" style="font-size: 30px; color: yellow">ACCOUNT NỔI BẬT</div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 padding-left-0 text-right">
                <div class="_btn-xtsp"><a href="MainController?action=Account" title="Xem tất cả" style="font: 16px 'Dosis', sans-serif;
                                          color: #fff;
                                          text-decoration: underline;
                                          display: inline-block;
                                          margin-top: 12px;">Xem tất cả <i class="fas fa-angle-double-right"></i></a></div>
            </div>
        </div>
        <main class="main row" style="min-width: 1230px;">
            <c:forEach var="account" items="${topAccount}">
