...
<html>
    ...
    <body>
        ...
        <div class="row main-account mt-3">
            ...
            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-7 text-center">
                <div class="title" style="font-size: 30px; color: #dc3545">ACCOUNT NỔI BẬT</div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 padding-left-0 text-right">
                <div class="_btn-xtsp"><a href="MainController?action=Account" title="Xem tất cả" style="font: 14px 'Dosis', sans-serif;
                                          color: #fff;
